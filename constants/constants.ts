...
export type Game = {
  ...
  image: string
  category: string
  users: { min: number, max: number } // Updated field
}
...
export const games: Game[] = [
  ...
  {
    title: "Vault Codes",
    description: "Crack the vault codes",
    href: "/games/vaultcodes",
    players: "21.5K",
    image: "/VaultCodes.webp",
    category: "live-casino",
    users: { min: 63, max: 100 },
  },
  {
    title: "Path Finder",
    description: "Connect all the dots without crossing lines",
  ...
  {
    title: "Number Count",
    description: "React to numbers as fast as you can",
    href: "/games/numberreact",
    players: "21.5K",
    image: "/numberreact.png",
    category: "live-casino",
    users: { min: 80, max: 100 },
  },
  {
    title: "Memory Matrix",
    description: "Match pairs of cards to test your memory",
    href: "/games/memorymatrix",
    players: "21.5K",
    image: "/MemoryMatrix.webp",
    category: "live-casino",
    users: { min: 36, max: 82 },
  },
  {
    title: "Boost Master",
    description: "Boost your skills with this challenging game",
    href: "/games/hackingdevice",
    players: "21.5K",
    image: "/Boosting.webp",
    category: "live-casino",
    users: { min: 50, max: 95 },
  ...
  {
    title: "Circuit Flow",
    description: "Connect the circuits to power up the system",
    href: "/games/Circuitflow",
    players: "21.5K",
    image: "/CircuitFlow.webp",
    category: "live-casino",
    users: { min: 21, max: 66 },
  },
  {
    title: "Digit Dazzle",
    description: "Test your memory with this digit recall game",
    href: "/games/digit-dazzle",
    players: "21.5K",
    image: "/DigitDazzle.webp",
    category: "live-casino",
    users: { min: 73, max: 100 },
  },
  {
    title: "Spot Game",
    description: "Find and click the hidden spot as quickly as possible",
    href: "/games/spot",
    players: "21.5K",
    image: "/spot.png",
    category: "originals",
  ...
  {
    title: "Roof Running",
    description: "Run across rooftops and avoid obstacles to reach the finish",
    href: "/games/roofrunning",
    players: "21.5K",
    image: "/roofrunning.png",
    category: "slots",
    users: { min: 58, max: 99 },
  },
  {
    title: "Stick Game",
    description: "Balance the stick and keep it upright for as long as you can",
    href: "/games/stickgame",
    players: "21.5K",
    image: "/stickgame.png",
    category: "table-games",
    users: { min: 17, max: 60 },
  ...
  {
    title: "Word Memory",
    description: "Test your memory with this word recall game",
    href: "/games/wordmemory",
    players: "21.5K",
    image: "/wordmemory.png",
    category: "table-games",
    users: { min: 66, max: 100 },
  },
  // Added games
  {
    title: "Circle Progress",
    description: "Track your progress as you complete circular challenges",
    href: "/games/circleprogress",
    players: "21.5K",
    image: "/circleprogress.png",
    category: "originals",
    users: { min: 20, max: 80 },
  },
  {
    title: "Progress",
    description: "Advance through levels by solving puzzles quickly",
    href: "/games/progress",
    players: "21.5K",
    image: "/progress.png",
    category: "slots",
  ...
  {
    title: "Number Slide",
    description: "Slide numbers into place to solve the puzzle",
    href: "/games/numberslide",
    players: "21.5K",
    image: "/numberslide.png",
    category: "table-games",
    users: { min: 15, max: 70 },
  },
  {
    title: "Rapid Lines",
    description: "Draw lines quickly to connect points and win",
    href: "/games/rapidlines",
    players: "21.5K",
    image: "/rapidlines.png",
    category: "originals",
    users: { min: 30, max: 85 },
  }
]
