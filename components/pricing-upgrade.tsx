...
export default function PricingSection() {
  ...
  const handleGetStarted = async (plan: PricingTier) => {
    ...
    try {
      ...
      Tebex.checkout.on("payment:complete", (data: any) => {
  ...
  return (
    <MaxWidthWrapper maxWidth="full">
      <div className="p-8 mx-auto space-y-8 mt-12">
        ...
        {/* MODIFICATION: Grid now changes at the '2xl' breakpoint */}
        <div className="grid grid-cols-1 md:grid-cols-6 2xl:grid-cols-5 gap-8">
          {plans.map((plan, index) => {
            ...
            // MODIFICATION: Conditional classes now reset at '2xl' instead of 'lg'
              ...
              >
                ...
                <CardContent className="space-y-6 flex-grow">
                  <div className="space-y-1">
                    <div className="text-4xl font-bold text-white">{formatPrice(plan.price[currency], currency)}</div>
